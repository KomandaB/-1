...
//    GoodCharactersMap[1] = GoodCharacter(1,"Makcim");
    ...
    BadCharactersMap[0] = BadCharacter(20,50,0,0,0,2);// Dangerouse rat
    BadCharactersMap[1] = BadCharacter(20,50,0,0,0,3);//
    BadCharactersMap[2] = BadCharacter(20,50,0,0,0,3);//
...
{
    GoodCharactersMap[0]=Goodcharacter(100,30,1,1,1,1);
